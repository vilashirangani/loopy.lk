...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="EditCompanyDetails.css">
    <?php
...
<div class="nav">
    ...
    <div class="topnav-right">
        ...
        <a href="../CompanyPage.php" class="login"><div> <img src="../../Images/useriamge.png"> </div> <?php echo $_SESSION['uname']?></a>
...
<div class="header" >
    ...
    <h1 style="color: lightskyblue"> Edit your details</h1>
</div>
